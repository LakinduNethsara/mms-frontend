        ...
        <div className="content">
          <Switch>
            ...
            {/* AR navigations starts here ---------------------------------------------*/}
              ...
              <Route exact path="/viewABUpdate/updateAB/:course_id/:course_name/:student_id/:grade/:marks_table_exam_type/:academic_year/:exam_type" component={UpdateABPage} />   {/* Link to AB status update form */}
